...
from onnxmltools.utils import dump_data_and_model, dump_single_regression, dump_multiple_regression, save_model, \
    dump_one_class_classification, dump_multiple_classification
