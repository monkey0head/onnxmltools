...
from onnxmltools.utils import dump_multiple_classification, dump_one_class_classification
...
class TestLightGbmTreeEnsembleModels(unittest.TestCase):
    ...
    def test_lightgbm_classifier(self):
        ...
        # dump_one_class_classification(model, allow_failure="StrictVersion(onnx.__version__) < StrictVersion('1.3.0')")
